...
public class Langleo extends Application {
	...
	private final String[] MIGRATIONS = new String[] {
			...
			"create table word(id integer primary key autoincrement, word text, translation text, list_id integer, studied integer)",
			...
			"create table studyday(id integer primary key autoincrement, date integer, newwords integer)",
			...
			"create table studysession(id integer primary key autoincrement, date integer, newwords integer)",
