...
public class Word extends Storable {
	...
	@DatabaseField private String translation;
	@DatabaseField private Boolean studied = false;
	@BelongsTo private List list;
	@HasOne(foreignField="word", dependent = true) private Question question;
